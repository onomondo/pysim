...
EF = {
    ...
    'IMSI_GSM': DF['GSM']+[EF_num['IMSI']],
    'IMSI_USIM':DF['GSM']+[EF_num['IMSI']],
    'Kc_GSM':   DF['GSM']+[EF_num['Kc_GSM']],
    'DCK':      DF['GSM']+[EF_num['DCK']],
    'PLMNsel':  DF['GSM']+[EF_num['PLMNsel']],
    'HPPLMN_GSM':   DF['GSM']+[EF_num['HPPLMN']],
...
# TODO: Figure out how to access to files under ADF_USIM
