...
EF_num = {
    ...
    'IPD_USIM': "6FF2",
    'ePDGId_USIM': "6FF3",
    'ePDGSelection_USIM': "6FF4",
    'ePDGIdEm_USIM': "6FF5",
    'ePDGSelectionEm_USIM': "6FF6",
    'FromPreferred_USIM': "6FF7",
    'IMSConfigData_USIM': "6FF8",
    'TVCONFIG_USIM': "6FFB",
    '3GPPPSDATAOFF_USIM': "6FF9",
    '3GPPPSDATAOFFservicelist_USIM': "6FFA",
    'XCAPConfigData_USIM': "6FFC",
    'EARFCNList_USIM': "6FFD",
    'MuDMiDConfigData_USIM': "6FYY",

    # DF_GSM_ACCESS
    'Kc_GSM_ACCESS': '4F20',
    'KcGPRS_GSM_ACCESS': '4F52',
    'CPBCCH_GSM_ACCESS': '4F63',
    'invSCAN_GSM_ACCESS': '4F64',
}
...
DF = {
    ...
    'current_active_ADF': [MF_num, DF_num['current_active_ADF']],
    'GSM_ACCESS': [MF_num, DF_num['ADF_USIM'], DF_num['GSM_ACCESS']],
    'PHONEBOOK': [MF_num, DF_num['TELECOM'], DF_num['PHONEBOOK']],
...
EF = {
    ...
    'FDN_Telecom':          DF['TELECOM']+[EF_num['FDN_Telecom']],
    'SMS_Telecom':          DF['TELECOM']+[EF_num['SMS_Telecom']],
    # 'CCP_Telecom':          DF['TELECOM']+[EF_num['CCP_Telecom']], #  There shall not be any EFCCP (with a file-id of '6F3D') under DFTELECOM because otherwise a GSM terminal could create inconsistencies within the phonebook.
    'MSISDN_Telecom':       DF['TELECOM']+[EF_num['MSISDN_Telecom']],
    'SMSP_Telecom':         DF['TELECOM']+[EF_num['SMSP_Telecom']],
    'SMSS_Telecom':         DF['TELECOM']+[EF_num['SMSS_Telecom']],
    'LND':                  DF['TELECOM']+[EF_num['LND']],
    'SMSR_Telecom':         DF['TELECOM']+[EF_num['SMSR_Telecom']],
    'SDN_Telecom':          DF['TELECOM']+[EF_num['SDN_Telecom']],
    'EXT1':                 DF['TELECOM']+[EF_num['EXT1']],
    'EXT2_Telecom':         DF['TELECOM']+[EF_num['EXT2_Telecom']],
    'EXT3_Telecom': DF['TELECOM']+[EF_num['EXT3_Telecom']],
    'BDN_Telecom':          DF['TELECOM']+[EF_num['BDN_Telecom']],
    'EXT4_Telecom':         DF['TELECOM']+[EF_num['EXT4_Telecom']],
    'CMI_Telecom':          DF['TELECOM']+[EF_num['CMI_Telecom']],
    'ECCP':                 DF['TELECOM']+[EF_num['ECCP']],
    'PSISMSC':              DF['TELECOM']+[EF_num['PSISMSC']],
    'RMA':                  DF['TELECOM']+[EF_num['RMA']],
    'ICE_DN':               DF['TELECOM']+[EF_num['ICE_DN']],
    'ICE_EF':               DF['TELECOM']+[EF_num['ICE_EF']],
    ...
    'LP_GSM':               DF['GSM']+[EF_num['LP_GSM']],
    'IMSI_GSM':             DF['GSM']+[EF_num['IMSI_GSM']],
    'Kc_GSM':               DF['GSM']+[EF_num['Kc_GSM']],
    'DCK_GSM':              DF['GSM']+[EF_num['DCK_GSM']],
    'PLMNsel':              DF['GSM']+[EF_num['PLMNsel']],
    'HPPLMN_GSM':           DF['GSM']+[EF_num['HPPLMN_GSM']],
    'CNL_GSM':              DF['GSM']+[EF_num['CNL_GSM']],
    'ACMmax_GSM':           DF['GSM']+[EF_num['ACMmax_GSM']],
    'SST':                  DF['GSM']+[EF_num['SST']],
    'ACM_GSM':              DF['GSM']+[EF_num['ACM_GSM']],
    'GID1_GSM':             DF['GSM']+[EF_num['GID1_GSM']],
    'GID2_GSM':             DF['GSM']+[EF_num['GID2_GSM']],
    'PUCT_GSM':             DF['GSM']+[EF_num['PUCT_GSM']],
    'CBMI_GSM':             DF['GSM']+[EF_num['CBMI_GSM']],
    'SPN_GSM':              DF['GSM']+[EF_num['SPN_GSM']],
    'CBMID_GSM':            DF['GSM']+[EF_num['CBMID_GSM']],
    'BCCH':                 DF['GSM']+[EF_num['BCCH']],
    'ACC_GSM':              DF['GSM']+[EF_num['ACC_GSM']],
    'FPLMN_GSM':            DF['GSM']+[EF_num['FPLMN_GSM']],
    # 'FPLMN':    DF['ADF_USIM']+[EF_num['FPLMN']],
    'LOCI_GSM':             DF['GSM']+[EF_num['LOCI_GSM']],
    'AD_GSM':               DF['GSM']+[EF_num['AD_GSM']],
    'PHASE':                DF['GSM']+[EF_num['PHASE']],
    'VGCS_GSM':             DF['GSM']+[EF_num['VGCS_GSM']],
    'VGCSS_GSM':            DF['GSM']+[EF_num['VGCSS_GSM']],
    'VBS_GSM':              DF['GSM']+[EF_num['VBS_GSM']],
    'VBSS_GSM':             DF['GSM']+[EF_num['VBSS_GSM']],
    'eMLPP_GSM':            DF['GSM']+[EF_num['eMLPP_GSM']],
    'AAeM':                 DF['GSM']+[EF_num['AAeM']],
    'ECC_GSM':              DF['GSM']+[EF_num['ECC_GSM']],
    'CBMIR_GSM':            DF['GSM']+[EF_num['CBMIR_GSM']],
    'NIA_GSM':              DF['GSM']+[EF_num['NIA_GSM']],
    'KcGPRS':               DF['GSM']+[EF_num['KcGPRS']],
    'LOCIGPRS':             DF['GSM']+[EF_num['LOCIGPRS']],
    'SUME':                 DF['GSM']+[EF_num['SUME']],
    'PLMNwAcT_GSM':         DF['GSM']+[EF_num['PLMNwAcT_GSM']],
    # 'PLMNwAcT_USIM':      DF['USIM']+[EF_num['PLMNwAcT']],
    'OPLMNwAcT':            DF['GSM']+[EF_num['OPLMNwAcT']],
    # Figure 8 names it HPLMNAcT, but in the text it's names it HPLMNwAcT
    # 'HPLMNAcT': DF['GSM']+[EF_num['HPLMNAcT']],
    'HPLMNwAcT_GSM':        DF['GSM']+[EF_num['HPLMNwAcT_GSM']],
    'CPBCCH':               DF['GSM']+[EF_num['CPBCCH']],
    'INVSCAN':              DF['GSM']+[EF_num['INVSCAN']],
    'PNN_GSM':              DF['GSM']+[EF_num['PNN_GSM']],
    'OPL_GSM':              DF['GSM']+[EF_num['OPL_GSM']],
    'MBDN_GSM':             DF['GSM']+[EF_num['MBDN_GSM']],
    'EXT6_GSM':             DF['GSM']+[EF_num['EXT6_GSM']],
    'MBI_GSM':              DF['GSM']+[EF_num['MBI_GSM']],
    'MWIS_GSM':             DF['GSM']+[EF_num['MWIS_GSM']],
    'CFIS_GSM':             DF['GSM']+[EF_num['CFIS_GSM']],
    'EXT7_GSM':             DF['GSM']+[EF_num['EXT7_GSM']],
    'SPDI_GSM':             DF['GSM']+[EF_num['SPDI_GSM']],
    'MMSN_GSM':             DF['GSM']+[EF_num['MMSN_GSM']],
    'EXT8_GSM':             DF['GSM']+[EF_num['EXT8_GSM']],
    'MMSICP_GSM':           DF['GSM']+[EF_num['MMSICP_GSM']],
    'MMSUP_GSM':            DF['GSM']+[EF_num['MMSUP_GSM']],
    'MMSUCP_GSM':           DF['GSM']+[EF_num['MMSUCP_GSM']],


    # ADF_USIM
    'LI_USIM':                       DF['ADF_USIM']+[EF_num['LI_USIM']],
    'IMSI_USIM':                     DF['ADF_USIM']+[EF_num['IMSI_USIM']],
    'Keys_USIM':                     DF['ADF_USIM']+[EF_num['Keys_USIM']],
    'KeysPS_USIM':                   DF['ADF_USIM']+[EF_num['KeysPS_USIM']],
    'PLMNwAcT_USIM':                 DF['ADF_USIM']+[EF_num['PLMNwAcT_USIM']],
    'HPPLMN_USIM':                   DF['ADF_USIM']+[EF_num['HPPLMN_USIM']],
    'ACMmax_USIM':                   DF['ADF_USIM']+[EF_num['ACMmax_USIM']],
    'UST_USIM':                      DF['ADF_USIM']+[EF_num['UST_USIM']],
    'ACM_USIM':                      DF['ADF_USIM']+[EF_num['ACM_USIM']],
    'GID1_USIM':                     DF['ADF_USIM']+[EF_num['GID1_USIM']],
    'GID2_USIM':                     DF['ADF_USIM']+[EF_num['GID2_USIM']],
    'SPN_USIM':                      DF['ADF_USIM']+[EF_num['SPN_USIM']],
    'PUCT_USIM':                     DF['ADF_USIM']+[EF_num['PUCT_USIM']],
    'CBMI_USIM':                     DF['ADF_USIM']+[EF_num['CBMI_USIM']],
    'ACC_USIM':                      DF['ADF_USIM']+[EF_num['ACC_USIM']],
    'FPLMN_USIM':                    DF['ADF_USIM']+[EF_num['FPLMN_USIM']],
    'LOCI_USIM':                     DF['ADF_USIM']+[EF_num['LOCI_USIM']],
    'AD_USIM':                       DF['ADF_USIM']+[EF_num['AD_USIM']],
    'CBMID_USIM':                    DF['ADF_USIM']+[EF_num['CBMID_USIM']],
    'ECC_USIM':                      DF['ADF_USIM']+[EF_num['ECC_USIM']],
    'CBMIR_USIM':                    DF['ADF_USIM']+[EF_num['CBMIR_USIM']],
    'PSLOCI_USIM':                   DF['ADF_USIM']+[EF_num['PSLOCI_USIM']],
    'FDN_USIM':                      DF['ADF_USIM']+[EF_num['FDN_USIM']],
    'SMS_USIM':                      DF['ADF_USIM']+[EF_num['SMS_USIM']],
    'MSISDN_USIM':                   DF['ADF_USIM']+[EF_num['MSISDN_USIM']],
    'SMSP_USIM':                     DF['ADF_USIM']+[EF_num['SMSP_USIM']],
    'SMSS_USIM':                     DF['ADF_USIM']+[EF_num['SMSS_USIM']],
    'SDN_USIM':                      DF['ADF_USIM']+[EF_num['SDN_USIM']],
    'EXT2_USIM':                     DF['ADF_USIM']+[EF_num['EXT2_USIM']],
    'EXT3_USIM':                     DF['ADF_USIM']+[EF_num['EXT3_USIM']],
    'SMSR_USIM':                     DF['ADF_USIM']+[EF_num['SMSR_USIM']],
    'ICI_USIM':                      DF['ADF_USIM']+[EF_num['ICI_USIM']],
    'OCI_USIM':                      DF['ADF_USIM']+[EF_num['OCI_USIM']],
    'ICT_USIM':                      DF['ADF_USIM']+[EF_num['ICT_USIM']],
    'OCT_USIM':                      DF['ADF_USIM']+[EF_num['OCT_USIM']],
    'EXT5_USIM':                     DF['ADF_USIM']+[EF_num['EXT5_USIM']],
    'CCP2_USIM':                     DF['ADF_USIM']+[EF_num['CCP2_USIM']],
    'eMLPP_USIM':                    DF['ADF_USIM']+[EF_num['eMLPP_USIM']],
    'AaeM_USIM':                     DF['ADF_USIM']+[EF_num['AaeM_USIM']],
    'Hiddenkey_USIM':                DF['ADF_USIM']+[EF_num['Hiddenkey_USIM']],
    'BDN_USIM':                      DF['ADF_USIM']+[EF_num['BDN_USIM']],
    'EXT4_USIM':                     DF['ADF_USIM']+[EF_num['EXT4_USIM']],
    'CMI_USIM':                      DF['ADF_USIM']+[EF_num['CMI_USIM']],
    'EST_USIM':                      DF['ADF_USIM']+[EF_num['EST_USIM']],
    'ACL_USIM':                      DF['ADF_USIM']+[EF_num['ACL_USIM']],
    'DCK_USIM':                      DF['ADF_USIM']+[EF_num['DCK_USIM']],
    'CNL_USIM':                      DF['ADF_USIM']+[EF_num['CNL_USIM']],
    'START_USIM':                    DF['ADF_USIM']+[EF_num['START_USIM']],
    'THRESHOLD_USIM':                DF['ADF_USIM']+[EF_num['THRESHOLD_USIM']],
    'OPLMNwAcT_USIM':                DF['ADF_USIM']+[EF_num['OPLMNwAcT_USIM']],
    'HPLMNwAcT_USIM':                DF['ADF_USIM']+[EF_num['HPLMNwAcT_USIM']],
    'NETPAR_USIM':                   DF['ADF_USIM']+[EF_num['NETPAR_USIM']],
    'PNN_USIM':                      DF['ADF_USIM']+[EF_num['PNN_USIM']],
    'OPL_USIM':                      DF['ADF_USIM']+[EF_num['OPL_USIM']],
    'MBDN_USIM':                     DF['ADF_USIM']+[EF_num['MBDN_USIM']],
    'EXT6_USIM':                     DF['ADF_USIM']+[EF_num['EXT6_USIM']],
    'MBI_USIM':                      DF['ADF_USIM']+[EF_num['MBI_USIM']],
    'MWIS_USIM':                     DF['ADF_USIM']+[EF_num['MWIS_USIM']],
    'CFIS_USIM':                     DF['ADF_USIM']+[EF_num['CFIS_USIM']],
    'EXT7_USIM':                     DF['ADF_USIM']+[EF_num['EXT7_USIM']],
    'SPDI_USIM':                     DF['ADF_USIM']+[EF_num['SPDI_USIM']],
    'MMSN_USIM':                     DF['ADF_USIM']+[EF_num['MMSN_USIM']],
    'EXT8_USIM':                     DF['ADF_USIM']+[EF_num['EXT8_USIM']],
    'MMSICP_USIM':                   DF['ADF_USIM']+[EF_num['MMSICP_USIM']],
    'MMSUP_USIM':                    DF['ADF_USIM']+[EF_num['MMSUP_USIM']],
    'MMSUCP_USIM':                   DF['ADF_USIM']+[EF_num['MMSUCP_USIM']],
    'NIA_USIM':                      DF['ADF_USIM']+[EF_num['NIA_USIM']],
    'VGCS_USIM':                     DF['ADF_USIM']+[EF_num['VGCS_USIM']],
    'VGCSS_USIM':                    DF['ADF_USIM']+[EF_num['VGCSS_USIM']],
    'VBS_USIM':                      DF['ADF_USIM']+[EF_num['VBS_USIM']],
    'VBSS_USIM':                     DF['ADF_USIM']+[EF_num['VBSS_USIM']],
    'VGCSCA_USIM':                   DF['ADF_USIM']+[EF_num['VGCSCA_USIM']],
    'VBSCA_USIM':                    DF['ADF_USIM']+[EF_num['VBSCA_USIM']],
    'GBABP_USIM':                    DF['ADF_USIM']+[EF_num['GBABP_USIM']],
    'MSK_USIM':                      DF['ADF_USIM']+[EF_num['MSK_USIM']],
    'MUK_USIM':                      DF['ADF_USIM']+[EF_num['MUK_USIM']],
    'GBANL_USIM':                    DF['ADF_USIM']+[EF_num['GBANL_USIM']],
    'EHPLMN_USIM':                   DF['ADF_USIM']+[EF_num['EHPLMN_USIM']],
    'EHPLMNPI_USIM':                 DF['ADF_USIM']+[EF_num['EHPLMNPI_USIM']],
    'LRPLMNSI_USIM':                 DF['ADF_USIM']+[EF_num['LRPLMNSI_USIM']],
    'NAFKCA_USIM':                   DF['ADF_USIM']+[EF_num['NAFKCA_USIM']],
    'SPNI_USIM':                     DF['ADF_USIM']+[EF_num['SPNI_USIM']],
    'PNNI_USIM':                     DF['ADF_USIM']+[EF_num['PNNI_USIM']],
    'NCP_USIM':                      DF['ADF_USIM']+[EF_num['NCP_USIM']],
    'EPSLOCI_USIM':                  DF['ADF_USIM']+[EF_num['EPSLOCI_USIM']],
    'EPSNSC_USIM':                   DF['ADF_USIM']+[EF_num['EPSNSC_USIM']],
    'UFC_USIM':                      DF['ADF_USIM']+[EF_num['UFC_USIM']],
    'NASCONFIG_USIM':                DF['ADF_USIM']+[EF_num['NASCONFIG_USIM']],
    'UICCIARI_USIM':                 DF['ADF_USIM']+[EF_num['UICCIARI_USIM']],
    'PWS_USIM':                      DF['ADF_USIM']+[EF_num['PWS_USIM']],
    'FDNURI_USIM':                   DF['ADF_USIM']+[EF_num['FDNURI_USIM']],
    'BDNURI_USIM':                   DF['ADF_USIM']+[EF_num['BDNURI_USIM']],
    'SDNURI_USIM':                   DF['ADF_USIM']+[EF_num['SDNURI_USIM']],
    'IWL_USIM':                      DF['ADF_USIM']+[EF_num['IWL_USIM']],
    'IPS_USIM':                      DF['ADF_USIM']+[EF_num['IPS_USIM']],
    'IPD_USIM':                      DF['ADF_USIM']+[EF_num['IPD_USIM']],
    'ePDGId_USIM':                   DF['ADF_USIM']+[EF_num['ePDGId_USIM']],
    'ePDGSelection_USIM':            DF['ADF_USIM']+[EF_num['ePDGSelection_USIM']],
    'ePDGIdEm_USIM':                 DF['ADF_USIM']+[EF_num['ePDGIdEm_USIM']],
    'ePDGSelectionEm_USIM':          DF['ADF_USIM']+[EF_num['ePDGSelectionEm_USIM']],
    'FromPreferred_USIM':            DF['ADF_USIM']+[EF_num['FromPreferred_USIM']],
    'IMSConfigData_USIM':            DF['ADF_USIM']+[EF_num['IMSConfigData_USIM']],
    'TVCONFIG_USIM':                 DF['ADF_USIM']+[EF_num['TVCONFIG_USIM']],
    '3GPPPSDATAOFF_USIM':            DF['ADF_USIM']+[EF_num['3GPPPSDATAOFF_USIM']],
    '3GPPPSDATAOFFservicelist_USIM': DF['ADF_USIM']+[EF_num['3GPPPSDATAOFFservicelist_USIM']],
    'XCAPConfigData_USIM':           DF['ADF_USIM']+[EF_num['XCAPConfigData_USIM']],
    'EARFCNList_USIM':               DF['ADF_USIM']+[EF_num['EARFCNList_USIM']],
    'MuDMiDConfigData_USIM':         DF['ADF_USIM']+[EF_num['MuDMiDConfigData_USIM']],

    # ADF_USIM_GSM_ACCESS
    'Kc_GSM_ACCESS':                DF['GSM_ACCESS']+[EF_num['Kc_GSM_ACCESS']],
    'KcGPRS_GSM_ACCESS':            DF['GSM_ACCESS']+[EF_num['KcGPRS_GSM_ACCESS']],
    'CPBCCH_GSM_ACCESS':            DF['GSM_ACCESS']+[EF_num['CPBCCH_GSM_ACCESS']],
    'invSCAN_GSM_ACCESS':           DF['GSM_ACCESS']+[EF_num['invSCAN_GSM_ACCESS']],
